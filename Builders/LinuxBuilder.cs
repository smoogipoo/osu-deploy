...
namespace osu.Desktop.Deploy.Builders
{
    public class LinuxBuilder : Builder
    {
        ...
        public override Uploader CreateUploader() => new LinuxVelopackUploader(Version, app_name, os_name, RuntimeIdentifier, RuntimeIdentifier, stagingPath: stagingTarget);
