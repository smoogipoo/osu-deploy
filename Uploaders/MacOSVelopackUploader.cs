...
namespace osu.Desktop.Deploy.Uploaders
{
    public class MacOSVelopackUploader : VelopackUploader
    {
        ...
        public MacOSVelopackUploader(string version, string applicationName, string operatingSystemName, string runtimeIdentifier, string channel, string? extraArgs = null, string? stagingPath = null)
